...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZWxkaW4zMCIsImEiOiJjbDhxeDRvOHgxZXduM29vNXBoZnozamJrIn0.OFkWYiwbRBPcGAyYWjsY-g';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/eldin30/cl8qxxcrx003w15lglhj5rrsu',
    scrollZoom: false
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).addTo(map); //coordinates su property u nasim tours documentima
    //Add popup

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, " ")).addTo(map); //Extend map bounds
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', 'Logging out failed!');
